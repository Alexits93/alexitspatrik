...
<body>
    ...
    <div id="knowledge">
        ...
        <div class="data-card">
            <div class="top"><h3>Back-end</h3></div>
            <div class="card-content">
                <ul>
        ...
        <div class="data-card">
            <div class="top"><h3>Front-end</h3></div>
            <div class="card-content">
                <ul>
        ...
        <div class="data-card">
            <div class="top"><h3>Worktools</h3></div>
            <div class="card-content">
                <ul>
                    ...
                    <li><img src="{{ URL::to('/images/card_content_bullet.png') }}" />Activecollab (Project management)</li>
